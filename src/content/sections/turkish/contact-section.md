...
form:
  emailSubject: "Nouvelle soumission de formulaire depuis le site atylus" # Sujet personnalisé de l’email (valable à chaque soumission)
  submitButton:
  ...
  inputs:
    ...
    - note: deprecated
      ...
      content: "Une erreur est survenue ! Veuillez utiliser cet e-mail - [atylus-astro-theme@gmail.com](mailto:atylus-astro-theme@gmail.com) pour soumettre un ticket !"
---
